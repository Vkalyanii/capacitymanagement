		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comappcapacitymanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappcapacitymanagement-display": {
								"semanticObject": "comappcapacitymanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.capacitymanagement",
									"url": sap.ui.require.toUrl("com/app/capacitymanagement")
								}
							}
						}
					}
