sap.ui.define(
  ...
  function (BaseController, Fragment, Filter, IconTabBar, IconTabFilter) {
    ...
    return BaseController.extend("com.app.capacitymanagement.controller.MainPage", {
      onInit: function () {
      ...
      handleValueHelp: function (oEvent) {
        ...
        if (!this._pValueHelpDialog) {
          this._pValueHelpDialog = Fragment.load({
            id: oView.getId(),
            name: "com.app.capacitymanagement.fragment.ProductsDialog",
            controller: this
      ...
      handleValueHelpProductType: function (oEvent) {
        ...
        if (!this._pProductsDialog) {
          this._pProductsDialog = Fragment.load({
            id: oView.getId(),
            name: "com.app.capacitymanagement.fragment.vehicleTypeDialog",
            controller: this
      ...
      onCancelInCreateVehicleDialog: function () {
        this.byId("idCreateInAddEquipmentDialog").close();
      },
      ...
      onCancelInEditVehicleDialog: function () {
        this.byId("idEditInAddEquipmentDialog").close();
      },
      ...
      onCancelInListCreateDialog: function () {
        this.byId("idListCreateDialog").close();
      },
      //edit dialog in list 
      ...
      onCancelInListEditDialog: function () {
        this.byId("idListEditDialog").close();
      },
    });
  }
);
